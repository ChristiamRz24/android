...
import com.google.firebase.example.osblogapp.databinding.DialogFiltersBinding
    ...
    private val selectedSortBy: String?
        get() {
            ...
            if (getString(R.string.sort_by_rating) == selected) {
                return OperatingSystem.FIELD_AVG_RATING
            }
            if (getString(R.string.sort_by_price) == selected) {
                return OperatingSystem.FIELD_PRICE
            }
            return if (getString(R.string.sort_by_popularity) == selected) {
                OperatingSystem.FIELD_POPULARITY
            } else {
                null
            }
        }
