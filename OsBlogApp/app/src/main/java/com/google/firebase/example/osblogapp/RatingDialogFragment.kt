...
import com.google.firebase.example.osblogapp.databinding.DialogRatingBinding
...
class RatingDialogFragment : DialogFragment() {
    ...
    override fun onCreateView(
        ...
        binding.osFormButton.setOnClickListener { onSubmitClicked() }
        binding.osFormCancel.setOnClickListener { onCancelClicked() }
    ...
    private fun onSubmitClicked() {
        ...
        user?.let {
            val rating = Rating(
                it,
                binding.osFormRating.rating.toDouble(),
                binding.osFormText.text.toString()
            )
