...
class ApplicationState extends ChangeNotifier {
  ...
  static Map<String, dynamic> defaultValues = <String, dynamic>{
    'event_date': 'Diciembre 20, 2022',
    'enable_free_swag': false,
    'call_to_action':
        '¡Únase a nosotros para pasar un día lleno de talleres de Firebase y pizza!',
  };
  ...
  Future<DocumentReference> addMessageToGuestBook(String message) {
    if (!_loggedIn) {
      throw Exception('¡Debe iniciar sesión para publicar un mensaje!');
    }
